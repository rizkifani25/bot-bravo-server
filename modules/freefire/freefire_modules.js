...
module.exports = FreeFire = async () => {
  let url = "http://www.kiosgamer.co.id",
    device = "192.168.1.5:3335",
    tujuan = "9206329072";
  const mainModule = new Promise((resolve, reject) => {
    Clipper(device)
      .then(response => {
        resolve(response);
      })
  ...
  mainModule
    .finally(() => console.log("Module done."))
    .then(response => {
  ...
  // Tap(625, 700, device)
  // await sleep(1000)
  // let text1 = await Clipper(device)
  // console.log("from module : " + text1)
  // Tap(550, 960, device)
